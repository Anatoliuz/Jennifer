...
public class EllipticCurve
{
    ...
    {
        /* Выбирается случайная точка на кривой, которая является основой для открытого ключа. (Не реализовано)
           Пока выбираем точку из стандарта NIST
         */
    ...
    private void generateRandomCurve(String userID)
    {
        /* Кривая задается двумя параметрами а и b, которые определяются
           алгоритмом Шофа или разложением на комплексные составляющие. (Не реализовано)
           Строка userID нужна для рандомизации. (Не реализовано)
           Проводится проверка на сингулярность. (Не реализовано)
